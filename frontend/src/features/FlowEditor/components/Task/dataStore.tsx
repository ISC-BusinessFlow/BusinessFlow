...
export const DataStore = forwardRef<SVGGElement, BaseTaskProps>(
  function DataStore({ task, translate }, ref) {
    ...
    return (
      <g ref={ref} transform={`translate(${translate.x}, ${translate.y})`}>
        ...
        <path
          ...
          strokeWidth="2"
        />
        <DisplayText x={0} y={20} width={size.width} height={size.height - 30}>
          {task.name}
        </DisplayText>
        {task.label && (
